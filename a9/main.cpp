...
public:
    ...
    virtual void Initialize_Data()
    {
        ...
        OpenGLTextureLibrary::Instance()->Add_Texture_From_File("tex/plant_color.jpg", "plant_color");
        ...
        OpenGLTextureLibrary::Instance()->Add_Texture_From_File("tex/bark.png", "bark_color");
        ...
        opengl_window->Add_Light(Vector3f(5, 40, 5), Vector3f(0.3, 0.2, 0.1), Vector3f(0.9, 0.9, 0.9), Vector3f(0.5, 0.5, 0.5)); 
        ...
        //// By default, we load a GT buzz + a number of stars
        {
            ...
            bgEffect->Add_Texture("tex_sky", OpenGLTextureLibrary::Get_Texture("sky_color")); // bgEffect can also Add_Texture
            bgEffect->Initialize();
        }
        ...
        {
            //// create object by reading an obj mesh
            auto plant = Add_Obj_Mesh_Object("obj/plant.obj");
            ...
            t << 0.05, 0, 0, 5,
                ...
                0, 0, 0.05, 5,
                0, 0, 0, 1;
            plant->Set_Model_Matrix(t);

            //// set object's material
            plant->Set_Ka(Vector3f(0.1, 0.1, 0.1));
            plant->Set_Kd(Vector3f(0.7, 0.7, 0.7));
            plant->Set_Ks(Vector3f(2, 2, 2));
            plant->Set_Shininess(128);

            //// bind texture to object
            plant->Add_Texture("tex_color", OpenGLTextureLibrary::Get_Texture("plant_color"));

            //// bind shader to object
            plant->Add_Shader_Program(OpenGLShaderLibrary::Get_Shader("basic"));
        }

        {
            //// create object by reading an obj mesh
            auto plant = Add_Obj_Mesh_Object("obj/Hazelnut.obj");
        ...
        {
            //// create object by reading an obj mesh
            auto plant = Add_Obj_Mesh_Object("obj/plants1.obj");
...

        {
            ...
            t << 20, 0, 0, -10,
                ...
                0, 0, 0, 1;
            Matrix4f r;
            float a = -3.1415926 * 0.5;
            r << cos(a), 0, -sin(a), 0,
                0, 1, 0, 0,
                sin(a), 0, cos(a), 0,
                0, 0, 0, 1;
            sqad->Set_Model_Matrix(t*r);
